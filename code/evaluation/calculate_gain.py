...
def load_word_movers_matrix(word_movers_matrix: str) -> pd.DataFrame:
    """
    Loads and return a pandas dataframe object of the cosine similarity.
    Parameters
    ----------
...
def fill_ndcg_scores(dcg_matrix: str, idcg_matrix: str) -> Tuple[List[str], ndarray]:
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', '--input', type=str,
                        help="Path for RELISH 4 column TSV file (with relevance and cosine similarity scores).")
